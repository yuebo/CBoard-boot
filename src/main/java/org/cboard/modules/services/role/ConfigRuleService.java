...
public class ConfigRuleService {
    ...
    @Around("execution(* org.cboard.modules.services.WidgetService.save(..)) || " +
            "execution(* org.cboard.modules.services.WidgetService.update(..)) || " +
    ...
    @Around("execution(* org.cboard.modules.services.DatasetService.save(..)) || " +
            "execution(* org.cboard.modules.services.DatasetService.update(..)) || " +
    ...
    @Around("execution(* org.cboard.modules.services.DatasourceService.save(..)) || " +
            "execution(* org.cboard.modules.services.DatasourceService.update(..)) || " +
    ...
    @Around("execution(* org.cboard.modules.services.BoardService.save(..)) || " +
            "execution(* org.cboard.modules.services.BoardService.update(..)) || " +
    ...
    @Around("execution(* org.cboard.modules.services.CategoryService.save(..)) || " +
            "execution(* org.cboard.modules.services.CategoryService.update(..)) || " +
    ...
    @Around("execution(* org.cboard.modules.services.AdminSerivce.addUser(..)) || " +
    ...
    @Around("execution(* org.cboard.modules.services.AdminSerivce.addRole(..)) || " +
            "execution(* org.cboard.modules.services.AdminSerivce.updateRole(..)) || " +
    ...
    @Around("execution(* org.cboard.modules.services.AdminSerivce.updateUserRole(..)) ||" +
